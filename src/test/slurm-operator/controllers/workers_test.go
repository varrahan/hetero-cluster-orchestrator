...
func TestCreateWorkerPodAndClaim(t *testing.T) {
	...
	demand := resourceplan.Demand{JobID: 7, GroupID: 7, PoolName: "strict", Count: 1, Shape: resourceplan.Shape{CPUs: 2, MemoryBytes: 2 << 30, GRES: map[string]int64{"gpu:rtx_4050": 1}}}
