...
> **Status:** Phases 0–3 pass their exit gates. Phase 4 fault recovery is
> implemented; its live kind gate is the remaining completion check.
...
- Slurm 26.05.3 with `select/cons_tres`, configless operation, dynamic
